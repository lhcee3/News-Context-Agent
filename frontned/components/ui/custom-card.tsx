...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-gray-800 bg-gradient-to-b from-gray-900 to-black text-gray-200 shadow-md backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/5",
      className,
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("text-2xl font-semibold leading-none tracking-tight text-blue-400", className)}
      {...props}
    />
  ),
)
